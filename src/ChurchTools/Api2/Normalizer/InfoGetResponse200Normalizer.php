...
class InfoGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'ChurchTools\\Api2\\Model\\InfoGetResponse200';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'ChurchTools\\Api2\\Model\\InfoGetResponse200';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \ChurchTools\Api2\Model\InfoGetResponse200();
