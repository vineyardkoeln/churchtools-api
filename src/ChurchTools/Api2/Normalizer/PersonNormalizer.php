...
class PersonNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (property_exists($data, 'securityLevelForPerson')) {
            $object->setSecurityLevelForPerson($data->{'securityLevelForPerson'});
        }
        if (property_exists($data, 'editSecurityLevelForPerson')) {
        ...
        if (property_exists($data, 'latitudeLoose')) {
            $object->setLatitudeLoose($data->{'latitudeLoose'});
        }
        if (property_exists($data, 'longitudeLoose')) {
        ...
        if (property_exists($data, 'familyImageUrl')) {
        ...
        if (property_exists($data, 'isArchived')) {
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if (null !== $object->getLatitudeLoose()) {
            $data->{'latitudeLoose'} = $object->getLatitudeLoose();
        }
        if (null !== $object->getLongitudeLoose()) {
        ...
        if (null !== $object->getFamilyImageUrl()) {
